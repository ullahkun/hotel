                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">LESTARI </span><span class="font-size-xl text-success">HOTEL</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="file" name="filefoto" class="dropify2" data-height="230">
                                    </div>
